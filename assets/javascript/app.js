...
var questions =[
        ...
        video: ' <video source src="assets/videos/Crash Test Dummies - The Ballad Of  Peter Pumpkinhead.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            name: 'X Files',
            ...
            video: ' <video source src="assets/videos/X-FILES  Walking After You  MULDERSCULLY  Revival.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            name: 'Trainspotting',
            ...
            video: ' <video source src="assets/videos/Trainspotting - Lust for life.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            name: "Romeo & Juliet",
            ...
            video: ' <video source src="assets/videos/Romeo and Juliet - Radiohead.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            ...
            video: ' <video source src="assets/videos/Neon Genesis Evangelion OP - Cruel Angels Thesis by Yoko Takahashi.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            name: "American Pie",
            ...
            video: ' <video source src="assets/videos/Tonic - You Wanted More.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            name: "Jerry McGuire",
            ...
            video: ' <video source src="assets/videos/Tom Petty - Free Fallin.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            name: "Mrs Doubtfire",
            ...
            video: ' <video source src="assets/videos/Aerosmith - Dude (Looks Like A Lady).mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            name: "City of Angels",
            ...
            video: ' <video source src="assets/videos/Alanis Morissette - Uninvited Acoustic Unplugged.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        },
        {
            ...
            video: ' <video source src="assets/videos/Case ft. Mary J. Blige  Foxy Brown- Touch Me, Tease Me.mp4" width="100%" height="60%" type="video/mp4" autoplay="autoplay"></video>'
        }
];
